  ...
  render() {
    ...
    return (
      <div className={classes.home}>
        ...
        <Divider />
        <Typography className={classes.homeContent}>
          Referring to Christ, Kierkegaard said, "the glory must be believed."
          So it is too for his followers, who share in his suffering, comfort,
          and glory. Ours too is the lowliness of the manger and the cross - a
          life dense with unseen glory. It must be believed not because it does
          not exist, but because often it is hard to see, to reconcile with our
          circumstances.
          <br />
          <br />
        ...
        <Typography className={classes.homeContent}>
          ...
          <a href="https://material-ui.com/">Material-UI</a> for making it easy
          to make this website. See the code on{" "}
